  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-center text-sm text-neutral-800 dark:text-neutral-300">
              ...
              <Link to="/login" className="underline underline-offset-4 text-indigo-600 dark:text-indigo-400">
                Login
              </Link>
            </div>
          </div>
          ...
          <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
            <span className="bg-white dark:bg-zinc-950 text-gray-600 dark:text-gray-400 relative z-10 px-2">
              Or
            </span>
          </div>
      ...
      <div className="text-gray-600 dark:text-gray-400 text-center text-xs text-balance">
        By clicking continue, you agree to our <a href="#" className="underline underline-offset-4 hover:text-indigo-600 dark:hover:text-indigo-400">Terms of Service</a>{" "}
        and <a href="#" className="underline underline-offset-4 hover:text-indigo-600 dark:hover:text-indigo-400">Privacy Policy</a>.
      </div>
    </div>
  )
}

...
const Postcard = ({ 
  ...
  return (
    <div className="w-150 bg-white dark:bg-zinc-800 rounded-lg border border-gray-300 dark:border-gray-600 overflow-hidden">
      ...
      <div className="p-4">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div>
            <h3 className="text-neutral-800 dark:text-neutral-300 font-medium">{userName}</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">{location} | Requesting from {requestingFromCountry}</p>
          </div>
        </div>
        <p className="text-neutral-800 dark:text-neutral-300 text-sm mb-3">
          {text}
        </p>
      </div>
      ...
      <div className="w-full h-48 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
        {imageUrl ? (
          ...
          <span className="text-gray-600 dark:text-gray-400">Image placeholder</span>
        )}
      </div>
